...
export const zhHant = defineLocale({
  ...
  commandCenter: {
    ...
    gatewayNotConfigured: '訊息渠道尚未啟用',
    hermesActiveSessions: (version, count) => `萌學伴 ${version} · 活躍工作階段 ${count}`,
    restartGateway: '重新啟動閘道',
    gatewayRestartFailed: '閘道重新啟動失敗。',
    updateHermes: '更新萌學伴',
    updateManagedExternally: '由管理員更新容器',
    actionRunning: '執行中',
    actionDone: '完成',
    actionFailed: '失敗',
  ...
  education: {
    ...
    home: {
      eyebrow: '教研工作臺',
      title: '今天想完成什麼？',
      description: '從目標開始，萌學伴會為你準備角色、資料來源、執行步驟和最終產物。',
      intentPlaceholder: '例如：整理小學五年級數學滬教版教材課程樹',
      intentAction: '準備任務',
      scenariosTitle: '常用教研場景',
      scenariosDescription: '已定義必要範圍和預期產物，選擇後再確認細節，不會直接執行。',
      continueTitle: '繼續處理',
      continueEmpty: '暫無需要處理的任務',
      continueEmptyDescription: '等待選擇或正在執行的任務會顯示在這裡。',
      sourceTitle: '資料來源狀態',
      sourceSummary: (available, total) => `${total} 個來源中 ${available} 個可用`
    },
    scenario: {
      courseTreeName: '教材課程樹',
    ...
    tasks: {
      title: '任務',
      description: '處理等待確認的問題、查看執行進度並開啟已完成的產物。',
      createTitle: '準備任務',
      createDescription: '所選場景會先收集明確目的和必要範圍，確認後才進入執行。',
      needsAttention: '需要我處理',
      running: '進行中',
      completed: '已完成',
      partial: '部分完成',
      empty: '還沒有任務',
      emptyDescription: '從首頁選擇一個教研場景，準備第一個任務。',
      purpose: '這次要完成什麼',
      purposePlaceholder: '說明使用對象、預期用途和希望得到的結果',
      fieldPlaceholder: field => `請選擇或填寫${field}`,
      continueToConfirm: '檢查任務內容',
      confirmTitle: '執行前確認',
      confirmDescription: '確認範圍和產物後才會建立任務；發現多個教材版本時仍會再次請你選擇。',
      editInformation: '返回修改',
      confirmCreate: '確認建立任務',
      created: '任務已建立，等待執行連線。',
      requiredHint: '必填',
      startExecution: '開始執行',
      startingExecution: '正在連線執行端…',
      openConversation: '開啟執行工作階段',
      executionFailed: '執行啟動失敗，請檢查 Gateway 連線後重試。',
      answerFailed: '提交選擇失敗，請重試或開啟執行工作階段處理。',
      openArtifacts: '查看產物'
    },
    sources: {
      title: '資料來源',
      description: '查看每個來源可以做什麼、支援什麼範圍以及目前是否可用。',
      capability: '可用能力',
      capabilityCatalogue: '目錄採集',
      capabilityRead: '內容讀取',
      capabilityRefresh: '定期更新',
      capabilitySearch: '資料搜尋',
      scope: '支援範圍',
      state: '目前狀態',
      available: '可用',
      notConfigured: '未設定',
      empty: '還沒有資料來源',
      emptyDescription: '設定後的教材來源、知識庫、聯網搜尋和文件會顯示在這裡。'
    },
    templates: {
      title: '角色與場景',
      description: '查看內建工作方式，或建立自己的副本進行調整。',
      safetyTitle: '內建範本始終保留',
      safetyDescription: '需要調整時先建立個人副本，修改不會影響其他使用者或官方更新。',
      rolesTitle: '角色',
      rolesDescription: '角色決定助手如何理解任務、使用能力和組織結果。',
      scenesTitle: '場景',
      scenesDescription: '場景定義需要確認的資訊、使用的角色和最終產物。',
      builtin: '內建',
      personal: '我的',
      createCopy: '建立我的副本',
      edit: '編輯',
      ...
      editSceneTitle: '編輯場景',
      name: '名稱',
      descriptionLabel: '用途說明',
      instruction: '工作要求',
      instructionHint: '說明這個角色應該如何判斷、確認和輸出。',
      assignedRole: '使用角色',
      inputs: count => `${count} 項必要資訊`,
      outputs: count => `${count} 個產物`,
      saved: '已儲存',
      saveFailed: '儲存失敗，請重試。'
    }
  },
