...
export const ja = defineLocale({
  ...
  commandCenter: {
    ...
    gatewayNotConfigured: 'メッセージングチャネルは未設定',
    hermesActiveSessions: (version, count) => `MengXueBan ${version} · アクティブセッション ${count}`,
    restartGateway: 'ゲートウェイを再起動',
    gatewayRestartFailed: 'ゲートウェイの再起動に失敗しました。',
    updateHermes: 'MengXueBan を更新',
    updateManagedExternally: 'コンテナ管理者が更新します',
    actionRunning: '実行中',
    actionDone: '完了',
    actionFailed: '失敗',
  ...
  education: {
    ...
    home: {
      eyebrow: '授業研究ワークスペース',
      title: '今日は何を完成させますか？',
      description: '目的から始めると、萌学伴が役割、資料、手順、成果物を準備します。',
      intentPlaceholder: '例：小学5年生の上海版数学の教材コースツリーを整理',
      intentAction: 'タスクを準備',
      scenariosTitle: 'よく使う教研シナリオ',
      scenariosDescription: '必要な範囲と成果物を定義済みです。詳細確認後に実行します。',
      continueTitle: '続ける',
      continueEmpty: '対応が必要なタスクはありません',
      continueEmptyDescription: '選択待ちや実行中のタスクがここに表示されます。',
      sourceTitle: 'データソースの状態',
      sourceSummary: (available, total) => `${total} 件中 ${available} 件が利用可能`
    },
    scenario: {
      courseTreeName: '教材コースツリー',
    ...
    tasks: {
      title: 'タスク',
      description: '確認待ち、進捗、完了した成果物を管理します。',
      createTitle: 'タスクを準備',
      createDescription: '実行前に目的と必要な範囲を確認します。',
      needsAttention: '確認が必要',
      running: '実行中',
      completed: '完了',
      partial: '一部完了',
      empty: 'タスクはまだありません',
      emptyDescription: 'ホームからシナリオを選んでください。',
      purpose: '今回達成すること',
      purposePlaceholder: '対象者、用途、期待する結果を説明してください',
      fieldPlaceholder: field => `${field}を選択または入力`,
      continueToConfirm: 'タスクを確認',
      confirmTitle: '実行前の確認',
      confirmDescription: '範囲と成果物を確認してから作成します。版が曖昧な場合は再度選択を求めます。',
      editInformation: '編集に戻る',
      confirmCreate: '確認して作成',
      created: 'タスクを作成し、実行接続を待っています。',
      requiredHint: '必須',
      startExecution: '実行を開始',
      startingExecution: '実行環境に接続中…',
      openConversation: '実行セッションを開く',
      executionFailed: '実行を開始できません。Gateway 接続を確認して再試行してください。',
      answerFailed: '選択を送信できません。再試行するか実行セッションを開いてください。',
      openArtifacts: '成果物を表示'
    },
    sources: {
      title: 'データソース',
      description: '利用可能な機能、対象範囲、現在の状態を確認します。',
      capability: '機能',
      capabilityCatalogue: '目録取得',
      capabilityRead: '内容読取',
      capabilityRefresh: '定期更新',
      capabilitySearch: '資料検索',
      scope: '対象範囲',
      state: '状態',
      available: '利用可能',
      notConfigured: '未設定',
      empty: 'データソースがありません',
      emptyDescription: '教材、知識ベース、ウェブ検索、ファイルがここに表示されます。'
    },
    templates: {
      title: 'ロールとシナリオ',
      description: '組み込みワークフローを使用するか、個人用コピーを作成して調整します。',
      safetyTitle: '組み込みテンプレートは常に保持されます',
      safetyDescription: '編集前に個人用コピーを作成します。変更は他のユーザーや公式更新に影響しません。',
      rolesTitle: 'ロール',
      rolesDescription: 'アシスタントの判断、機能、結果の整理方法を定義します。',
      scenesTitle: 'シナリオ',
      scenesDescription: '必要情報、使用ロール、成果物を定義します。',
      builtin: '組み込み',
      personal: '自分用',
      createCopy: '自分用コピーを作成',
      edit: '編集',
      editRoleTitle: 'ロールを編集',
      editSceneTitle: 'シナリオを編集',
      name: '名前',
      descriptionLabel: '用途',
      instruction: '作業指示',
      instructionHint: '判断、確認、出力の方法を説明します。',
      assignedRole: '使用ロール',
      inputs: count => `必須情報 ${count} 件`,
      outputs: count => `成果物 ${count} 件`,
      saved: '保存しました',
