...
export const en: Translations = {
  ...
  notifications: {
    ...
    updateHermes: 'Update MengXueBan',
  ...
  commandCenter: {
    ...
    gatewayNotConfigured: 'Messaging channels not configured',
    hermesActiveSessions: (version, count) => `MengXueBan ${version} · Active sessions ${count}`,
    restartGateway: 'Restart gateway',
    gatewayRestartFailed: 'Gateway restart failed.',
    updateHermes: 'Update MengXueBan',
    updateManagedExternally: 'Updated by the container administrator',
