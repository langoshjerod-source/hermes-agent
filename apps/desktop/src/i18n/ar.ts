...
export const ar = defineLocale({
  ...
  commandCenter: {
    ...
    gatewayNotConfigured: 'قنوات المراسلة غير مهيأة',
    hermesActiveSessions: (version, count) => `MengXueBan ${version} لديه ${count} جلسة نشطة`,
    restartGateway: 'إعادة تشغيل البوابة',
    gatewayRestartFailed: 'فشل إعادة تشغيل البوابة.',
    updateHermes: 'تحديث MengXueBan',
    updateManagedExternally: 'يتم التحديث بواسطة مسؤول الحاوية',
  ...
  education: {
    nav: {
      ...
      templates: 'الأدوار والسيناريوهات'
    },
    home: {
      eyebrow: 'مساحة عمل البحث التربوي',
      title: 'ماذا تريد أن تنجز اليوم؟',
      description: 'ابدأ بالهدف، وسيجهز MengXueBan الدور والمصادر والخطوات والمخرجات.',
      intentPlaceholder: 'مثال: تنظيم شجرة دروس كتاب الرياضيات للصف الخامس',
      intentAction: 'إعداد المهمة',
      scenariosTitle: 'سيناريوهات شائعة',
      scenariosDescription: 'النطاق والمخرجات المطلوبة محددة مسبقاً، ويبدأ التنفيذ بعد التأكيد.',
      continueTitle: 'متابعة',
      continueEmpty: 'لا توجد مهام تحتاج إلى انتباهك',
      continueEmptyDescription: 'ستظهر هنا المهام المنتظرة أو قيد التنفيذ.',
      sourceTitle: 'حالة مصادر البيانات',
      sourceSummary: (available, total) => `${available} من ${total} مصادر متاحة`
    },
    scenario: {
      courseTreeName: 'شجرة دروس الكتاب',
    ...
    tasks: {
      title: 'المهام',
      description: 'تابع التأكيدات والتقدم وافتح المخرجات المكتملة.',
      createTitle: 'إعداد مهمة',
      createDescription: 'يجمع السيناريو الهدف والنطاق المطلوبين قبل التنفيذ.',
      needsAttention: 'تحتاج إلى انتباه',
      running: 'قيد التنفيذ',
      completed: 'مكتملة',
      partial: 'مكتملة جزئياً',
      empty: 'لا توجد مهام بعد',
      emptyDescription: 'اختر سيناريو من الصفحة الرئيسية لإعداد المهمة الأولى.',
      purpose: 'ما الهدف من هذه المهمة؟',
      purposePlaceholder: 'صف الجمهور والاستخدام المتوقع والنتيجة المطلوبة',
      fieldPlaceholder: field => `اختر أو أدخل ${field}`,
      continueToConfirm: 'مراجعة المهمة',
      confirmTitle: 'تأكيد قبل التنفيذ',
      confirmDescription: 'تُنشأ المهمة بعد تأكيد النطاق والمخرجات. الإصدارات الملتبسة تتطلب اختياراً إضافياً.',
      editInformation: 'العودة للتعديل',
      confirmCreate: 'تأكيد وإنشاء',
      created: 'تم إنشاء المهمة وهي بانتظار اتصال التنفيذ.',
      requiredHint: 'مطلوب',
      startExecution: 'بدء التنفيذ',
      startingExecution: 'جارٍ الاتصال بالتنفيذ…',
      openConversation: 'فتح جلسة التنفيذ',
      executionFailed: 'تعذر بدء التنفيذ. تحقق من اتصال Gateway وحاول مرة أخرى.',
      answerFailed: 'تعذر إرسال الاختيار. أعد المحاولة أو افتح جلسة التنفيذ.',
      openArtifacts: 'عرض المخرجات'
    },
    sources: {
      title: 'مصادر البيانات',
      description: 'اطّلع على قدرات كل مصدر ونطاقه وحالته الحالية.',
      capability: 'القدرة',
      capabilityCatalogue: 'جمع الفهرس',
      capabilityRead: 'قراءة المحتوى',
      capabilityRefresh: 'تحديث دوري',
      capabilitySearch: 'البحث',
      scope: 'النطاق',
      state: 'الحالة',
      available: 'متاح',
      notConfigured: 'غير مهيأ',
      empty: 'لا توجد مصادر بيانات',
      emptyDescription: 'ستظهر هنا مصادر الكتب وقاعدة المعرفة والبحث والملفات.'
    },
    templates: {
      title: 'الأدوار والسيناريوهات',
      description: 'استخدم القوالب المضمنة أو أنشئ نسخة شخصية للتعديل.',
      safetyTitle: 'تبقى القوالب المضمنة محفوظة',
      safetyDescription: 'أنشئ نسخة شخصية قبل التعديل. لن تؤثر تغييراتك في المستخدمين الآخرين أو التحديثات الرسمية.',
      rolesTitle: 'الأدوار',
      rolesDescription: 'تحدد الأدوار كيفية فهم المساعد للعمل واستخدام القدرات وتنظيم النتائج.',
      scenesTitle: 'السيناريوهات',
      scenesDescription: 'تحدد السيناريوهات المعلومات المطلوبة والدور والمخرجات.',
      builtin: 'مضمن',
      personal: 'خاصتي',
      createCopy: 'إنشاء نسختي',
      edit: 'تعديل',
      editRoleTitle: 'تعديل الدور',
      editSceneTitle: 'تعديل السيناريو',
      name: 'الاسم',
      descriptionLabel: 'الغرض',
      instruction: 'تعليمات العمل',
      instructionHint: 'صف طريقة اتخاذ القرار والتأكيد وإنتاج النتائج.',
      assignedRole: 'الدور المستخدم',
      inputs: count => `${count} مدخلات مطلوبة`,
      outputs: count => `${count} مخرجات`,
      saved: 'تم الحفظ',
